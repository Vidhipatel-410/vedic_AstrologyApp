...
var Planet = /* @__PURE__ */ ((Planet2) => {
  ...
  Planet2[Planet2["Earth"] = 14] = "Earth";
  Planet2[Planet2["EclipticNutation"] = -1] = "EclipticNutation";
  Planet2[Planet2["FixedStar"] = -10] = "FixedStar";
  return Planet2;
})(Planet || {});
...
var CommonCalculationFlags = {
  ...
  Astrometric: 1024 /* NoAberration */ | 512 /* NoGravitationalDeflection */,
  /** Default flags for Swiss Ephemeris with speed */
  DefaultSwissEphemeris: 2 /* SwissEphemeris */ | 256 /* Speed */,
  /** Default flags for Moshier with speed */
  DefaultMoshier: 4 /* MoshierEphemeris */ | 256 /* Speed */
};
...
var CommonEclipseTypes = {
  ...
  AllSolar: 1 /* Central */ | 2 /* NonCentral */ | 4 /* Total */ | 8 /* Annular */ | 16 /* Partial */ | 32 /* AnnularTotal */,
  /** All types of lunar eclipses */
  AllLunar: 4 /* Total */ | 16 /* Partial */ | 64 /* Penumbral */
};
...
var LunarEclipseImpl = class {
  ...
  isTotal() {
    return (this.type & 4 /* Total */) !== 0;
  }
  isPartial() {
    return (this.type & 16 /* Partial */) !== 0;
  }
  isPenumbralOnly() {
    return (this.type & 64 /* Penumbral */) !== 0 && (this.type & (4 /* Total */ | 16 /* Partial */)) === 0;
  }
  getTotalityDuration() {
...
var SolarEclipseImpl = class {
  ...
  isAnnular() {
    return (this.type & 8 /* Annular */) !== 0;
  }
  isHybrid() {
    return (this.type & 32 /* AnnularTotal */) !== 0;
  }
  isPartial() {
    return (this.type & 16 /* Partial */) !== 0;
  }
  isCentral() {
    return (this.type & 1 /* Central */) !== 0;
  }
  isNonCentral() {
    return (this.type & 2 /* NonCentral */) !== 0;
  }
};
var DateTimeImpl = class {
  constructor(year, month, day, hour, calendarType = 1 /* Gregorian */) {
    this.year = year;
    this.month = month;
    this.day = day;
    this.hour = hour;
  ...
  toString() {
    const calType = this.calendarType === 1 /* Gregorian */ ? "Gregorian" : "Julian";
...
// src/flags.ts
var CalculationFlags = class _CalculationFlags {
  ...
  static get heliocentric() {
    return _CalculationFlags.from(2 /* SwissEphemeris */, 8 /* Heliocentric */);
  }
  /**
   * Common preset: Topocentric positions
   */
  static get topocentric() {
    return _CalculationFlags.from(2 /* SwissEphemeris */, 32768 /* Topocentric */);
  }
  /**
...
var EclipseTypeFlags = class _EclipseTypeFlags {
  constructor(initialFlags) {
    this.flags = 0;
    if (initialFlags !== void 0) {
      this.add(initialFlags);
  ...
  static get totalOnly() {
    return _EclipseTypeFlags.from(4 /* Total */);
  }
  /**
   * Preset: Total and partial eclipses (no penumbral)
   */
  static get totalAndPartial() {
    return _EclipseTypeFlags.from(4 /* Total */, 16 /* Partial */);
  }
};
