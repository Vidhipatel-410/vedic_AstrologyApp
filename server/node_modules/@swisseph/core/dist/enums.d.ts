 ...
 */
export declare enum LunarPoint {
 ...
 */
export declare enum FictitiousPlanet {
    /** Cupido (Uranian) */
    Cupido = 40,
    /** Hades (Uranian) */
    Hades = 41,
 ...
 */
export declare enum HousePoint {
    /** Ascendant */
    Ascendant = 0,
 ...
 */
export declare enum CalculationFlag {
 ...
 */
export declare enum RiseTransitFlag {
    /** Rising event */
    Rise = 1,
    /** Setting event */
    Set = 2,
...
export declare const PlanetaryMoonOffset = 9000;
export declare const NumberOfPlanets = 23;
